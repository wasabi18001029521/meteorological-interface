...
import cn.webyun.meteorologicalinterface.entity.RoleCriteria.Criteria;
import cn.webyun.meteorologicalinterface.entity.RoleCriteria.Criterion;
...
public class RoleSqlProvider {
    ...
    protected void applyWhere(SQL sql, RoleCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
