...
import cn.webyun.meteorologicalinterface.entity.UserRoleCriteria.Criteria;
import cn.webyun.meteorologicalinterface.entity.UserRoleCriteria.Criterion;
...
public class UserRoleSqlProvider {
    ...
    protected void applyWhere(SQL sql, UserRoleCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
